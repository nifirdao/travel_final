    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <?php if(isset($_SESSION['adminname'])) : ?>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo ADMINURL; ?>/province-admins/show-province.php" style="margin-left: 20px;">Province</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo ADMINURL; ?>/attraction-admins/show-cities.php" style="margin-left: 20px;">Attraction</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo ADMINURL; ?>/register-admins/show-bookings.php" style="margin-left: 20px;">Register</a>
            </li>
            </ul>
        <?php endif; ?>    
